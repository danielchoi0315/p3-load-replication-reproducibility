...
FEATURE_REUSE_ROOTS: Dict[str, Path] = {
    "ds003655": Path("/project_cache/features/confirmatory_reference/ds003655"),
    "ds004117": Path("/project_cache/features/confirmatory_reference/ds004117"),
    "ds005095": Path("/project_cache/features/confirmatory_reference/ds005095"),
    "ds004796": Path("/project_cache/features/clinical_translation_reference/ds004796"),
    # Reuse validated mechanism features to avoid repeated partial epoch corruption.
    "ds003838": Path("/project_cache/features/normative_reference/ds003838"),
}
...
def parse_args() -> argparse.Namespace:
    ...
    ap.add_argument("--data_root", type=Path, default=Path("/project_data/openneuro"))
...
def main() -> int:
    ...
    out_root = args.out_root or (Path("/project_runs") / f"{ts}_NN_FINAL_MEGA_V2_BIO")
    features_root = args.features_root or Path(f"/project_cache/features_NN_FINAL_MEGA_V2_BIO_{ts}")

...
def parse_args() -> argparse.Namespace:
    ...
    ap.add_argument(
        ...
        type=Path,
        default=Path("/project_cache/features/confirmatory_reference"),
    )
    ap.add_argument(
        "--features_root_mechanism",
        type=Path,
        default=Path("/project_cache/features/mechanism_reference"),
    )
...
def main() -> int:
    ...
    if out_root is None:
        ...
        out_root = Path("/project_runs") / f"{ts}_NN_SOLID_1_2"

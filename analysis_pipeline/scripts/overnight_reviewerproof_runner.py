...
def parse_args() -> argparse.Namespace:
    ...
    ap.add_argument("--features_root", type=Path, default=Path("/project_cache/features/confirmatory_reference"))
...
def main() -> int:
    ...
    if out_root is None:
        ...
        out_root = Path("/project_runs") / f"{ts}_OVERNIGHT_REVIEW_FIX2"

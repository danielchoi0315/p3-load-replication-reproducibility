...
Options:
  --data_root <path>            (default: /project_data/openneuro)
  --out_root <path>             (default: /project_runs/<timestamp>)
  --features_root <path>        (default: /project_cache/features)
  --log_root <path>             (default: /project_logs)
  --clinical_bids_root <path>   (default: /project_data/clinical_bids)

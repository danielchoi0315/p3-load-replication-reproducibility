...
This archive contains a reviewer-facing snapshot of the analysis code/provenance repository plus figure source-data CSV files for the submitted manuscript.
...
- `source_data/`: CSV files used to generate or audit the submitted main and supplementary figures.
...
A DOI-backed archive can be added later if one is created before acceptance or publication.
